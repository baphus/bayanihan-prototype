...
export default function AppSidebar({ navigation, user, onLogout, logo }: AppSidebarProps): JSX.Element {
  const location = useLocation()

  return (
    <aside className="w-64 bg-[#f8f9fa] border-r border-slate-200 flex flex-col justify-between hidden md:flex shrink-0 h-full font-body">
      <div>
        {/* Logo Section */}
